...
import {
  ...
  Edit3, Check, X, AlertTriangle, CheckCircle, Info, Trash2, BookOpen, Users
} from 'lucide-react';
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--paper)' }}>
      ...
      <main style={{ maxWidth: 900, margin: '0 auto', padding: '40px 24px' }}>
        ...
        {(review.comments || []).map((clause, idx) => (
          <ClauseSection key={idx} clause={clause} index={idx}
            onUpdateClause={updated => updateClause(idx, updated)}
            currentUser={currentUser}
          />
        ))}
      </main>
